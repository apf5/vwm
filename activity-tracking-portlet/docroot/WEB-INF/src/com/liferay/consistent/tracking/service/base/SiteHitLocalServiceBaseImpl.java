...
/**
 * The base implementation of the site hit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.SiteHitLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SiteHitLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SiteHitLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.SiteHitLocalServiceUtil} to access the site hit local service.
	 */
	...
	public SiteHit addSiteHit(SiteHit siteHit) throws SystemException {
		siteHit.setNew(true);
	 ...
	 */
	public SiteHit createSiteHit(long hitId) {
		return siteHitPersistence.create(hitId);
	}
	...
	public SiteHit deleteSiteHit(long hitId)
		throws PortalException, SystemException {
		return siteHitPersistence.remove(hitId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SiteHit deleteSiteHit(SiteHit siteHit) throws SystemException {
		return siteHitPersistence.remove(siteHit);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SiteHit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return siteHitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return siteHitPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return siteHitPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return siteHitPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SiteHit fetchSiteHit(long hitId) throws SystemException {
		return siteHitPersistence.fetchByPrimaryKey(hitId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SiteHit getSiteHit(long hitId)
		throws PortalException, SystemException {
		return siteHitPersistence.findByPrimaryKey(hitId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return siteHitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SiteHit> getSiteHits(int start, int end)
		throws SystemException {
		return siteHitPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSiteHitsCount() throws SystemException {
		return siteHitPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SiteHit updateSiteHit(SiteHit siteHit) throws SystemException {
		return updateSiteHit(siteHit, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SiteHit updateSiteHit(SiteHit siteHit, boolean merge)
		throws SystemException {
		siteHit.setNew(false);

		return siteHitPersistence.update(siteHit, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.SiteHit",
			siteHitLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = siteHitPersistence.getDataSource();
	...
	private SiteHitLocalServiceClpInvoker _clpInvoker = new SiteHitLocalServiceClpInvoker();
}