...
/**
 * The base implementation of the portlet hit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.PortletHitLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PortletHitLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PortletHitLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.PortletHitLocalServiceUtil} to access the portlet hit local service.
	 */
	...
	public PortletHit addPortletHit(PortletHit portletHit)
	 ...
	 */
	public PortletHit createPortletHit(long hitId) {
		return portletHitPersistence.create(hitId);
	}
	...
	public PortletHit deletePortletHit(long hitId)
		throws PortalException, SystemException {
		return portletHitPersistence.remove(hitId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PortletHit deletePortletHit(PortletHit portletHit)
		throws SystemException {
		return portletHitPersistence.remove(portletHit);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PortletHit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return portletHitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return portletHitPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return portletHitPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PortletHit fetchPortletHit(long hitId) throws SystemException {
		return portletHitPersistence.fetchByPrimaryKey(hitId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletHit getPortletHit(long hitId)
		throws PortalException, SystemException {
		return portletHitPersistence.findByPrimaryKey(hitId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return portletHitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PortletHit> getPortletHits(int start, int end)
		throws SystemException {
		return portletHitPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPortletHitsCount() throws SystemException {
		return portletHitPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PortletHit updatePortletHit(PortletHit portletHit)
		throws SystemException {
		return updatePortletHit(portletHit, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PortletHit updatePortletHit(PortletHit portletHit, boolean merge)
		throws SystemException {
		portletHit.setNew(false);

		return portletHitPersistence.update(portletHit, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.PortletHit",
			portletHitLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = portletHitPersistence.getDataSource();
	...
	private PortletHitLocalServiceClpInvoker _clpInvoker = new PortletHitLocalServiceClpInvoker();
}