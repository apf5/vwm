...
/**
 * The base implementation of the filelog local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.FilelogLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FilelogLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FilelogLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.FilelogLocalServiceUtil} to access the filelog local service.
	 */
	...
	public Filelog addFilelog(Filelog filelog) throws SystemException {
		filelog.setNew(true);
	 ...
	 */
	public Filelog createFilelog(long FilelogId) {
		return filelogPersistence.create(FilelogId);
	}
	...
	public Filelog deleteFilelog(long FilelogId)
		throws PortalException, SystemException {
		return filelogPersistence.remove(FilelogId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Filelog deleteFilelog(Filelog filelog) throws SystemException {
		return filelogPersistence.remove(filelog);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Filelog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return filelogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return filelogPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return filelogPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return filelogPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Filelog fetchFilelog(long FilelogId) throws SystemException {
		return filelogPersistence.fetchByPrimaryKey(FilelogId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Filelog getFilelog(long FilelogId)
		throws PortalException, SystemException {
		return filelogPersistence.findByPrimaryKey(FilelogId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return filelogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Filelog> getFilelogs(int start, int end)
		throws SystemException {
		return filelogPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFilelogsCount() throws SystemException {
		return filelogPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Filelog updateFilelog(Filelog filelog) throws SystemException {
		return updateFilelog(filelog, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Filelog updateFilelog(Filelog filelog, boolean merge)
		throws SystemException {
		filelog.setNew(false);

		return filelogPersistence.update(filelog, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.Filelog",
			filelogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = filelogPersistence.getDataSource();
	...
	private FilelogLocalServiceClpInvoker _clpInvoker = new FilelogLocalServiceClpInvoker();
}