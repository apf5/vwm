...
/**
 * The base implementation of the organization hit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.OrganizationHitLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class OrganizationHitLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrganizationHitLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.OrganizationHitLocalServiceUtil} to access the organization hit local service.
	 */
	...
	public OrganizationHit addOrganizationHit(OrganizationHit organizationHit)
	 ...
	 */
	public OrganizationHit createOrganizationHit(long hitId) {
		return organizationHitPersistence.create(hitId);
	}
	...
	public OrganizationHit deleteOrganizationHit(long hitId)
		throws PortalException, SystemException {
		return organizationHitPersistence.remove(hitId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public OrganizationHit deleteOrganizationHit(
		OrganizationHit organizationHit) throws SystemException {
		return organizationHitPersistence.remove(organizationHit);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(OrganizationHit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return organizationHitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return organizationHitPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public OrganizationHit fetchOrganizationHit(long hitId)
		throws SystemException {
		return organizationHitPersistence.fetchByPrimaryKey(hitId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OrganizationHit getOrganizationHit(long hitId)
		throws PortalException, SystemException {
		return organizationHitPersistence.findByPrimaryKey(hitId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return organizationHitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<OrganizationHit> getOrganizationHits(int start, int end)
		throws SystemException {
		return organizationHitPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOrganizationHitsCount() throws SystemException {
		return organizationHitPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OrganizationHit updateOrganizationHit(
		OrganizationHit organizationHit) throws SystemException {
		return updateOrganizationHit(organizationHit, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public OrganizationHit updateOrganizationHit(
		OrganizationHit organizationHit, boolean merge)
		throws SystemException {
		organizationHit.setNew(false);

		return organizationHitPersistence.update(organizationHit, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.OrganizationHit",
			organizationHitLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = organizationHitPersistence.getDataSource();
	...
	private OrganizationHitLocalServiceClpInvoker _clpInvoker = new OrganizationHitLocalServiceClpInvoker();
}