...
/**
 * The base implementation of the userlog local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.UserlogLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class UserlogLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UserlogLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.UserlogLocalServiceUtil} to access the userlog local service.
	 */
	...
	public Userlog addUserlog(Userlog userlog) throws SystemException {
		userlog.setNew(true);
	 ...
	 */
	public Userlog createUserlog(long userlogId) {
		return userlogPersistence.create(userlogId);
	}
	...
	public Userlog deleteUserlog(long userlogId)
		throws PortalException, SystemException {
		return userlogPersistence.remove(userlogId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Userlog deleteUserlog(Userlog userlog) throws SystemException {
		return userlogPersistence.remove(userlog);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Userlog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userlogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userlogPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return userlogPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userlogPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Userlog fetchUserlog(long userlogId) throws SystemException {
		return userlogPersistence.fetchByPrimaryKey(userlogId);
	}
	...
	public Userlog getUserlog(long userlogId)
		throws PortalException, SystemException {
		return userlogPersistence.findByPrimaryKey(userlogId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userlogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Userlog> getUserlogs(int start, int end)
		throws SystemException {
		return userlogPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserlogsCount() throws SystemException {
		return userlogPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Userlog updateUserlog(Userlog userlog) throws SystemException {
		return updateUserlog(userlog, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Userlog updateUserlog(Userlog userlog, boolean merge)
		throws SystemException {
		userlog.setNew(false);

		return userlogPersistence.update(userlog, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.Userlog",
			userlogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userlogPersistence.getDataSource();
	...
	private UserlogLocalServiceClpInvoker _clpInvoker = new UserlogLocalServiceClpInvoker();
}