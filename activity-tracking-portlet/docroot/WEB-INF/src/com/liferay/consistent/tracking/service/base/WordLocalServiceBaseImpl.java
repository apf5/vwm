...
/**
 * The base implementation of the word local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.WordLocalServiceImpl}.
 * </p>
 *
...
public abstract class WordLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements WordLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.WordLocalServiceUtil} to access the word local service.
	 */
	...
	public Word addWord(Word word) throws SystemException {
		word.setNew(true);

		return wordPersistence.update(word, false);
	}
	...
	public Word deleteWord(long wordId) throws PortalException, SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Word deleteWord(Word word) throws SystemException {
	...
	public Word fetchWord(long wordId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Word getWord(long wordId) throws PortalException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Word> getWords(int start, int end) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getWordsCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Word updateWord(Word word) throws SystemException {
		return updateWord(word, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Word updateWord(Word word, boolean merge) throws SystemException {
		word.setNew(false);

		return wordPersistence.update(word, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.Word",
			wordLocalService);
	}
	...
	private WordLocalServiceClpInvoker _clpInvoker = new WordLocalServiceClpInvoker();
}