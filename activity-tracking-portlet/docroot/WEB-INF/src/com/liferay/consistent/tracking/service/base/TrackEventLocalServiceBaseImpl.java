...
/**
 * The base implementation of the track event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.TrackEventLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TrackEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrackEventLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.TrackEventLocalServiceUtil} to access the track event local service.
	 */
	...
	public TrackEvent addTrackEvent(TrackEvent trackEvent)
		throws SystemException {
		trackEvent.setNew(true);

		return trackEventPersistence.update(trackEvent, false);
	}
	 ...
	 */
	public TrackEvent createTrackEvent(long trackEventId) {
		return trackEventPersistence.create(trackEventId);
	}
	...
	public TrackEvent deleteTrackEvent(long trackEventId)
		throws PortalException, SystemException {
		return trackEventPersistence.remove(trackEventId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TrackEvent deleteTrackEvent(TrackEvent trackEvent)
		throws SystemException {
		return trackEventPersistence.remove(trackEvent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TrackEvent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trackEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return trackEventPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trackEventPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrackEvent fetchTrackEvent(long trackEventId)
		throws SystemException {
		return trackEventPersistence.fetchByPrimaryKey(trackEventId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrackEvent getTrackEvent(long trackEventId)
		throws PortalException, SystemException {
		return trackEventPersistence.findByPrimaryKey(trackEventId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trackEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrackEvent> getTrackEvents(int start, int end)
		throws SystemException {
		return trackEventPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrackEventsCount() throws SystemException {
		return trackEventPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrackEvent updateTrackEvent(TrackEvent trackEvent)
		throws SystemException {
		return updateTrackEvent(trackEvent, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TrackEvent updateTrackEvent(TrackEvent trackEvent, boolean merge)
		throws SystemException {
		trackEvent.setNew(false);

		return trackEventPersistence.update(trackEvent, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.TrackEvent",
			trackEventLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trackEventPersistence.getDataSource();
	...
	private TrackEventLocalServiceClpInvoker _clpInvoker = new TrackEventLocalServiceClpInvoker();
}