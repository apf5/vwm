...
/**
 * The base implementation of the browsinglog local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.BrowsinglogLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BrowsinglogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BrowsinglogLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.BrowsinglogLocalServiceUtil} to access the browsinglog local service.
	 */
	...
	public Browsinglog addBrowsinglog(Browsinglog browsinglog)
		throws SystemException {
		browsinglog.setNew(true);

		return browsinglogPersistence.update(browsinglog, false);
	}
	 ...
	 */
	public Browsinglog createBrowsinglog(long browsinglogId) {
		return browsinglogPersistence.create(browsinglogId);
	}
	...
	public Browsinglog deleteBrowsinglog(long browsinglogId)
		throws PortalException, SystemException {
		return browsinglogPersistence.remove(browsinglogId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Browsinglog deleteBrowsinglog(Browsinglog browsinglog)
		throws SystemException {
		return browsinglogPersistence.remove(browsinglog);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Browsinglog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return browsinglogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return browsinglogPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return browsinglogPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Browsinglog fetchBrowsinglog(long browsinglogId)
		throws SystemException {
		return browsinglogPersistence.fetchByPrimaryKey(browsinglogId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Browsinglog getBrowsinglog(long browsinglogId)
		throws PortalException, SystemException {
		return browsinglogPersistence.findByPrimaryKey(browsinglogId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return browsinglogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Browsinglog> getBrowsinglogs(int start, int end)
		throws SystemException {
		return browsinglogPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getBrowsinglogsCount() throws SystemException {
		return browsinglogPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Browsinglog updateBrowsinglog(Browsinglog browsinglog)
		throws SystemException {
		return updateBrowsinglog(browsinglog, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Browsinglog updateBrowsinglog(Browsinglog browsinglog, boolean merge)
		throws SystemException {
		browsinglog.setNew(false);

		return browsinglogPersistence.update(browsinglog, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.Browsinglog",
			browsinglogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = browsinglogPersistence.getDataSource();
	...
	private BrowsinglogLocalServiceClpInvoker _clpInvoker = new BrowsinglogLocalServiceClpInvoker();
}