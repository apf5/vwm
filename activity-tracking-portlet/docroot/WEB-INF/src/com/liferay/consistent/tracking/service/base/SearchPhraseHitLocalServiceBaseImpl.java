...
/**
 * The base implementation of the search phrase hit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.SearchPhraseHitLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SearchPhraseHitLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SearchPhraseHitLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.SearchPhraseHitLocalServiceUtil} to access the search phrase hit local service.
	 */
	...
	public SearchPhraseHit addSearchPhraseHit(SearchPhraseHit searchPhraseHit)
	 ...
	 */
	public SearchPhraseHit createSearchPhraseHit(long hitId) {
		return searchPhraseHitPersistence.create(hitId);
	}
	...
	public SearchPhraseHit deleteSearchPhraseHit(long hitId)
		throws PortalException, SystemException {
		return searchPhraseHitPersistence.remove(hitId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SearchPhraseHit deleteSearchPhraseHit(
		SearchPhraseHit searchPhraseHit) throws SystemException {
		return searchPhraseHitPersistence.remove(searchPhraseHit);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SearchPhraseHit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return searchPhraseHitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return searchPhraseHitPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SearchPhraseHit fetchSearchPhraseHit(long hitId)
		throws SystemException {
		return searchPhraseHitPersistence.fetchByPrimaryKey(hitId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SearchPhraseHit getSearchPhraseHit(long hitId)
		throws PortalException, SystemException {
		return searchPhraseHitPersistence.findByPrimaryKey(hitId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return searchPhraseHitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SearchPhraseHit> getSearchPhraseHits(int start, int end)
		throws SystemException {
		return searchPhraseHitPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSearchPhraseHitsCount() throws SystemException {
		return searchPhraseHitPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SearchPhraseHit updateSearchPhraseHit(
		SearchPhraseHit searchPhraseHit) throws SystemException {
		return updateSearchPhraseHit(searchPhraseHit, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public SearchPhraseHit updateSearchPhraseHit(
		SearchPhraseHit searchPhraseHit, boolean merge)
		throws SystemException {
		searchPhraseHit.setNew(false);

		return searchPhraseHitPersistence.update(searchPhraseHit, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.SearchPhraseHit",
			searchPhraseHitLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = searchPhraseHitPersistence.getDataSource();
	...
	private SearchPhraseHitLocalServiceClpInvoker _clpInvoker = new SearchPhraseHitLocalServiceClpInvoker();
}