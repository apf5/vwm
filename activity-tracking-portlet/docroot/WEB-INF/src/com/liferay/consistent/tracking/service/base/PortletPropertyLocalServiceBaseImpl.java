...
/**
 * The base implementation of the portlet property local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.consistent.tracking.service.impl.PortletPropertyLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PortletPropertyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PortletPropertyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.consistent.tracking.service.PortletPropertyLocalServiceUtil} to access the portlet property local service.
	 */
	...
	public PortletProperty addPortletProperty(PortletProperty portletProperty)
		throws SystemException {
		portletProperty.setNew(true);

		return portletPropertyPersistence.update(portletProperty, false);
	}
	 ...
	 */
	public PortletProperty createPortletProperty(long propertyId) {
		return portletPropertyPersistence.create(propertyId);
	}
	...
	public PortletProperty deletePortletProperty(long propertyId)
		throws PortalException, SystemException {
		return portletPropertyPersistence.remove(propertyId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PortletProperty deletePortletProperty(
		PortletProperty portletProperty) throws SystemException {
		return portletPropertyPersistence.remove(portletProperty);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PortletProperty.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return portletPropertyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return portletPropertyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PortletProperty fetchPortletProperty(long propertyId)
		throws SystemException {
		return portletPropertyPersistence.fetchByPrimaryKey(propertyId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletProperty getPortletProperty(long propertyId)
		throws PortalException, SystemException {
		return portletPropertyPersistence.findByPrimaryKey(propertyId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return portletPropertyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PortletProperty> getPortletProperties(int start, int end)
		throws SystemException {
		return portletPropertyPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPortletPropertiesCount() throws SystemException {
		return portletPropertyPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PortletProperty updatePortletProperty(
		PortletProperty portletProperty) throws SystemException {
		return updatePortletProperty(portletProperty, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public PortletProperty updatePortletProperty(
		PortletProperty portletProperty, boolean merge)
		throws SystemException {
		portletProperty.setNew(false);

		return portletPropertyPersistence.update(portletProperty, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.consistent.tracking.model.PortletProperty",
			portletPropertyLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = portletPropertyPersistence.getDataSource();
	...
	private PortletPropertyLocalServiceClpInvoker _clpInvoker = new PortletPropertyLocalServiceClpInvoker();
}