...
/* Jhanlos: Agregando el rastreo de las palabras y fraces mas buscadas */
Message message = new Message();
message.put("companyId", company.getCompanyId());
message.put("keywords", keywords);
message.put("guest", themeDisplay.getUser().getDefaultUser());
message.put("access", new Date());

MessageBusUtil.sendMessage("tracking/searchhit", message);
