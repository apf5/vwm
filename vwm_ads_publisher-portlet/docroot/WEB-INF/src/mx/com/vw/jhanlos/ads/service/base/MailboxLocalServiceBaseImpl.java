...
/**
 * The base implementation of the mailbox local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link mx.com.vw.jhanlos.ads.service.impl.MailboxLocalServiceImpl}.
 * </p>
 *
 * @author Jorge Loayza
...
public abstract class MailboxLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link mx.com.vw.jhanlos.ads.service.MailboxLocalServiceUtil} to access the mailbox local service.
	 */
	...
	public Mailbox addMailbox(Mailbox mailbox) throws SystemException {
		...
		return mailboxPersistence.update(mailbox, false);
	}
	...
	public Mailbox updateMailbox(Mailbox mailbox) throws SystemException {
		return updateMailbox(mailbox, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Mailbox updateMailbox(Mailbox mailbox, boolean merge)
		throws SystemException {
		mailbox.setNew(false);

		return mailboxPersistence.update(mailbox, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("mx.com.vw.jhanlos.ads.model.Mailbox",
			mailboxLocalService);
	}
